...
class Order extends AppModel {
    ...
    public static function saveOrder($data){
        ...
        $order->np_city = $data['np_city'];
        $order->np_warehouse = $data['np_warehouse'];
    ...
    public static function mailOrder($order_id, $user_email){
        try{
            ...
            $message_client = (new Swift_Message("Ви зробили замовлення №{$order_id} на сайті " . App::$app->getProperty('shop_name')))
        ...
        $_SESSION['success'] = 'Дякую за замовлення! Найближчим часом з Вами звяжеться менеджер';
    }
