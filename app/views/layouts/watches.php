...
<body class="theme-<?php echo config('site_colour'); ?>">
    ...
    <div class="umenu">
        <div class="umenu__wrapper">
            ...
            <div class="soc-row-footer" style="margin-left:85px;">
...
<footer>
    <div class="footer-content">
        <div class="container">
            <!--<div class="warning-message">
                ...
                Товари еротичного характеру не підлягають поверненню або заміні
            </div>
            <div class="warning-message">
                <img src="/images/18.svg" alt="warn">
                Перегляд представлених матеріалів дозволений тільки особам старше 18 років!
            </div>-->
            <a href="#" class="oferta-link">Публичная оферта</a>
            <a href="#" class="oferta-link">Блог</a>
            <div class="soc-row">
                <a href="<?php echo config('footer_facebook'); ?>" class="social-item">
                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 42C32.598 42 42 32.598 42 21C42 9.40202 32.598 0 21 0C9.40202 0 0 9.40202 0 21C0 32.598 9.40202 42 21 42Z" fill="#3B5998"/>
    ...
    <div class="footer-line">© 2022 Все захищено!<br><a href="https://web.wobbly.in">By Wobbly</a></div>
</footer>
